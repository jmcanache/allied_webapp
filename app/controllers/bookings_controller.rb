  ...
  def create
    ...
    if new_booking
      ...
      if @booking.save    
        ...
        hotel_recipient = ['r.hernandez@allied-hospitality.com', hotel.name]
        guest_recipient = ['r.hernandez@allied-hospitality.com', @booking.name]
        allied_recipient = ['r.hernandez@allied-hospitality.com', 'Allied Hospitality']
